...
cs.setElementArea(1) # NOTE: The smaller the element size, the better the calculated results. Defaults to 0.001 if this line is omitted.
...
print(f"Moment of Inertia (XX, YY, XY):", cs.MomentOfInertia())
